        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FavoritesVisibility = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MiniDescription = table.Column<string>(type: "longtext", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FavoritedPostsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostFavorites", x => new { x.FavoritedByUsersId, x.FavoritedPostsId });
                    table.ForeignKey(
                        name: "FK_PostFavorites_Posts_FavoritedPostsId",
                        column: x => x.FavoritedPostsId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PostFavorites_Users_FavoritedByUsersId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RepostedByUsersId = table.Column<int>(type: "int", nullable: false),
                    RepostedPostsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostReposts", x => new { x.RepostedByUsersId, x.RepostedPostsId });
                    table.ForeignKey(
                        name: "FK_PostReposts_Posts_RepostedPostsId",
                        column: x => x.RepostedPostsId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PostReposts_Users_RepostedByUsersId",
                        column: x => x.RepostedByUsersId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NoteFiles_PostId",
                table: "NoteFiles",
                column: "PostId");

            migrationBuilder.CreateIndex(
                name: "IX_PostFavorites_FavoritedPostsId",
                table: "PostFavorites",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostReposts_RepostedPostsId",
                table: "PostReposts",
